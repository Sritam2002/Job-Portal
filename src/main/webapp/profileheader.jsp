...
<html>
    ...
    <body>
        <div class="row header_bg">
            ...
            <div class="col-md-6">
                <span style="color: yellow;"> <a href="profile.jsp" style="text-decoration: none; color: white; font-size: 18px"> <img src="profilepics/<jsp:expression>profile_pic</jsp:expression>" height="30" style="border-radius: 15px; border: 3px solid grey;"/> <jsp:expression> name </jsp:expression> </a> </span>
            </div>
            <div class="col-md-2">
