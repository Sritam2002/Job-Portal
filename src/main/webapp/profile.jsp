            ...
            <div class="col-md-8">
                <div class="row" style="border: 1px solid gray; box-shadow: 0px 0px 2px gray; border-radius: 3px">
                    <div class="col-md-3" style="margin:auto;">
                        <a href="edit-profile-pic.jsp" style="font-size: 16px; float: right"> <span class="glyphicon glyphicon-plus"></span></a>
                        <img src="profilepics/<jsp:expression>profile_pic</jsp:expression>" height="100" style="border-radius: 50px; border:4px solid grey;"/>
                         <br>
                        <h4 style="text-align:center;">Profile Pic</h4>
                    </div>
                    <div class="col-md-9">
                        <h3 style="color: blue"> <jsp:expression> name.toUpperCase()</jsp:expression> <a href="edit-profile-about.jsp" style="font-size: 16px; float: right"> <span class="glyphicon glyphicon-pencil"></span> </a> </h3>
                    ...
                    <div class="row"  style="border: 1px solid gray; box-shadow: 0px 0px 2px gray; border-radius: 3px">
                        ...
                        <div class="row">
                            ...
                            if(f.exists())
                            {
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                 <a href="DownloadResumeBuilder?fn=<%= emaill %>.pdf" class="btn btn-success"> Download Resume </a>
