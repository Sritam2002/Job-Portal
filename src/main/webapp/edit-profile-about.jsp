        ...
        <script>
            function val(v)
           {
            ...
            function validation()
            {
                ...
                var name2=document.editProfile.name1.value;
            ...
            <div class="col-md-8">
                <div class="row" style="border: 1px solid gray; box-shadow: 0px 0px 2px gray; border-radius: 3px">
                    ...
                    <div class="col-md-10">
                        ...
                        <form action="EditProfileAbout" method="POST" onsubmit="return validation()" name="editProfile">
                            <b> <jsp:expression>name</jsp:expression> </b>(<jsp:expression> session.getAttribute("session_email") </jsp:expression>) <br> <br>
                            <input type="text" value="<jsp:expression> name</jsp:expression>" name="name1" class="textfield_design" placeholder="Enter Name"  onkeyup="val('name_error')" /> <br> <span id="name_error" style="color: red"> </span><br> <br>
